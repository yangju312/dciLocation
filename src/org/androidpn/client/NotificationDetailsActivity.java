...
import Gis.namespace.Location.tzactivity;
...
public class NotificationDetailsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File dataf=  new File("/sdcard/80/zjdafh");
        ...
        cv.put(TZ.ID, id+1);
        cv.put(TZ.TITLE, notificationTitle);
        cv.put(TZ.MESSAGE, notificationMessage);
        cv.put(TZ.URL, notificationUri);
        db.insert(TZ.TABLE_NAME, null, cv);
        db.close();
        c.close();
//        Cursor c1 = db.query(TZ.TABLE_NAME,  new String[] {TZ.ID}, null,null,null,null,null);
...
//        Intent in;
//        
//        in=new Intent(NotificationDetailsActivity.this,tzactivity.class);
//        startActivity(in);
...
//                            callbackActivityClassName);
                	intent=new Intent(NotificationDetailsActivity.this,tzactivity.class);
