...
import Gis.namespace.Location.GISLocationActivity;
...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
	   ...
	   c.close();
	   db.close();
//        xmppHost = props.getProperty("xmppHost", LoginActivity.setip);
        xmppPort = props.getProperty("xmppPort", 8080+"");
        xmppHost =  setip;
        }
        catch(Exception e)
        {
        	 xmppHost = props.getProperty("xmppHost", "59.41.9.212");
             xmppPort = props.getProperty("xmppPort", 8080+"");
        }
//        xmppPort =  LoginActivity.setdk;
        Log.i(LOGTAG, "apiKey=" + apiKey);
...
////                Intent intent1 =new Intent("locationservice");
